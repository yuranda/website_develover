        ...
        <div class="copyright-section">
          <div class="row">
            <div class="col-md-7">
              <p>
                 <small>
      Hak Cipta &copy; 2017 <?php if(date('Y')!=2017) echo "- ".date('Y'); ?> Jasa Mantenen Servis All rights reserved. Develop By 
      <a  href="http://facebook.com/Jasa Mantenen Servis(JMS)" target="_blank"><span class="accent-color">JMS</span></a>
                </small>
              </p>
            </div>
            <div class="col-md-5">
